...
<link rel="stylesheet" type="text/css"
	href="../static/section4_2/index.css">
</head>
				...
				<div id="s_fm" class="s_form">
					<div class="s_form_wrapper soutu-env-mac" id="s_form_wrapper">
						<a id="result_logo"
							...
							rc="../static/section4_2/search.png"> <img
							class="s_lg_img_gold_showre"
							src="../static/section4_2/search.png">
						</a>
						...
						<form name="f" id="form" action="" class="fm"
							...
							<span id="s_kw_wrap" class="bg s_ipt_wr quickdelete-wrap"
								...
								type="submit" value="询证检索" id="su" class="btn self-btn bg s_btn">
							</span>
						</form>
					</div>
				</div>
			...
			<div id="container" class="container_l">
				<div id="content_left" style="margin-top: 100px;">
					...
					<div class="result c-container ">
						<h3 class="t">
							<a href="http://www.meng.uno" target="_blank"><em>匡盟盟</em></a>
						</h3>
						<div class="c-abstract">
							查看<em>匡盟盟</em> (在读本科生 - 哈工大,黑龙江 哈尔滨)
							的领英职业档案。加入领英,找找同事同学,结识业界同行,与其他职场人士一起驰骋职场。
						</div>
					</div>
